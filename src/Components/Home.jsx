  ...
  return (
    ...
    <div className='grid grid-cols-12 mb-[8%]'>
      <div className='col-span-7'>
        ...
        <img className='w-15 h-15 mx-2 bg-gray-200 rounded-lg hover:bg-gray-300' src={linkdin}/>
        <img className='w-15 h-15 mx-2 bg-gray-200 rounded-xl hover:bg-gray-300' src={instagram}/>
      </div>
      </div>
